    ...
    return (
      <a-entity rotation={this.props.rot} position={this.props.pos}>
        ...
        <a-entity>
          ...
          <Entity primitive="a-plane" src="https://www.lamborghini.com/themes/custom/lambo/img/base/logo.png" rotation=" 0 0" height="0.5" width="1" position={{ x: this.state.grid[1].x, y: this.state.grid[1].y + 1.35, z: this.state.grid[1].z }} />
          <Entity primitive="a-text" color={this.state.stockPriceColor} height="0.5" width="8" value="550k" position={{ x: this.state.grid[1].x-.55, y: this.state.grid[1].y + 0.8, z: this.state.grid[1].z }} />
        </a-entity>
        <a-entity>
