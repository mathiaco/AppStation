    ...
    render() {
        return (
            <a-entity>
                ...
                <Entity primitive="a-text" color="black" height="0.5" width="1" wrap-count="20" value={this.state.news[this.props.newsNumber].title} position={{ x: this.props.x - 0.5, y: this.props.y + 0.8, z: this.props.z }} />
